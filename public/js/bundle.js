...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXNlcnJhbm8iLCJhIjoiY2swenl3ZHNzMDBkYjNicWlobXRnaDltOSJ9.DYtnUVGsoT4bzssmGcfIUA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p class=popup> <strong>Day ".concat(loc.day, ":</strong> ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
...
/* eslint-disable */
var signup = function signup(name, email, password, passwordConfirm, role) {
  var res;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (password !== passwordConfirm) (0, _alert.showAlert)('error', 'Passwords do not match');
...
/* eslint-disable */
var stripe = Stripe('pk_test_gPvswZTaamwz1noofh32qwRZ00Ewa6nHah');
